...
/docs
/docs ├── N_COIN_Stateless_Consensus_Currency(English).pdf ├── N_COIN_Stateless_Consensus_Currency(Japanese).pdf ├── N_COIN_Report2_Simulation(English).pdf └── N_COIN_Report2_Simulation(Japanese).pdf
